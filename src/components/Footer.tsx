    ...
    <div className="container mx-auto">
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to="/Why-It-Matters" className="text-sm text-background/60 hover:text-background transition-colors">Why It Matters</Link>
            <Link to="/request" className="text-sm text-background/60 hover:text-background transition-colors">Request a Toy</Link>
      ...
      <div className="border-t border-background/10 mt-8 pt-8 text-center text-sm text-background/40">
        <p className="flex items-center justify-center gap-1">
          Made with <Heart className="w-4 h-4 text-primary fill-primary" /> by the Adaptive Tech Club
        </p>
      </div>
    </div>
  </footer>
