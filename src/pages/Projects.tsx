...
const Projects = () => {
  const [filter, setFilter] = useState<"all" | "toy" | "device" | "tool">("all");
    ...
    <Layout>
      <section className="container mx-auto py-16 md:py-24">
        <div className="text-center mb-12">
          <h1 className="font-display font-extrabold text-4xl md:text-5xl mb-4">Our Projects</h1>
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Browse everything we've built and adapted. Click on projects with documentation to see build guides.
          </p>
        </div>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-3">
                    <span className={`px-2 py-1 rounded-md text-xs font-medium ${complexityColor[project.complexity]}`}>
                      {project.complexity}
                    </span>
                  ...
                  {project.hasDocumentation ? (
                    ...
                    <span className="text-xs text-muted-foreground">Documentation coming soon</span>
                  )}
                </div>
              </div>
            );
